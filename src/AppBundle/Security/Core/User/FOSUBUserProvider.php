...
use AppBundle\Security\Core\User\Provider\FacebookProvider;
use AppBundle\Security\Core\User\Provider\ExternalProviderInterface;
...
class FOSUBUserProvider extends BaseClass {
    ...
    private function getExternalUserProvider(UserResponseInterface $response) {
        ...
        switch(strtolower($serviceName)) {
            case 'facebook' : return new FacebookProvider($this->userManager, $response); break;
